...
//     setHabits([
//       ...habits,
//       { name, progress: parseInt(progress), color: randomColor() },
//     ]);
//     setName('');
//     setProgress('');
//   };
...
//       {/* Navbar */}
//       <nav className="w-full px-8 py-5 bg-white shadow-md flex justify-between items-center mb-10">
//         <h1 className="text-3xl font-extrabold text-blue-600">Habit Tracker</h1>
//         <span className="text-sm text-gray-500">Next.js + Tailwind ✨</span>
//       </nav>
...
//                 >
//                   <span className="font-medium">{habit.name}</span>
//                   <span className="font-bold text-blue-600">{habit.progress}%</span>
//                 </motion.div>
//               ))}
//             </div>
//           </section>
...
//       {/* Footer */}
//       <footer className="text-center text-sm text-gray-500 pb-6">
//         © 2025 Habit Tracker · Built with ❤️ using Next.js + Tailwind CSS
//       </footer>
//     </main>
//   );
// };
